                    ...
                    <View style={styles.content}>
                        ...
                        <View style={styles.buttonContainer}>
                            <TouchableOpacity
                                ...
                                onPress={() => router.push('/pages/signup/register')} // Navigate to your main screen
                            >
                            ...
                            <TouchableOpacity style={styles.secondaryButton} onPress={() => router.push('/pages/signin/auth')}>

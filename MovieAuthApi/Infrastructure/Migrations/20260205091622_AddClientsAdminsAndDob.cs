...
{
    /// <inheritdoc />
    public partial class AddClientsAdminsAndDob : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminProfileId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClientProfileId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TheatreId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Halls_Theatre_TheatreId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoogleAuthedUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GoogleAuthedUsers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BannedUsers_Admins_AdminProfileId",
                        column: x => x.AdminProfileId,
                        principalTable: "Admins",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BannedUsers_Clients_ClientProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WatchlistItems_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WatchlistItems_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BannedUsers_AdminProfileId",
                table: "BannedUsers",
                column: "AdminProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_BannedUsers_ClientProfileId",
                table: "BannedUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreTranslations_GenreId_Language",
                table: "GenreTranslations",
                columns: new[] { "GenreId", "Language" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GoogleAuthedUsers_UserId",
                table: "GoogleAuthedUsers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieTranslations_MovieId_Language",
                table: "MovieTranslations",
                columns: new[] { "MovieId", "Language" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_HallId_RowNumber_ColumnNumber",
                table: "Seats",
                columns: new[] { "HallId", "RowNumber", "ColumnNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchlistItems_ClientId",
                table: "WatchlistItems",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_WatchlistItems_GenreId",
                table: "WatchlistItems",
                column: "GenreId");
